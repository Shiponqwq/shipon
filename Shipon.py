...
def notice():
	...
	runtxt("\033[0;92m ADMIN MESSENGER🔰Shipon")
...
class Main:
	def __init__(self):
		...
		self.loop = 0
		try:
			plr = requests.get('https://raw.githubusercontent.com/Shipon-Hacker/text/main/Dis').text
			if basesplit in plr:
				key = basesplit
...
\033[1;91m [\033[1;94m✓\033[1;91m] \033[1;92mGITHUB   : Hacker-Shipon
